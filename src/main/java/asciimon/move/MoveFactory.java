...
public class MoveFactory {
    private static final Map<String, Supplier<Move>> moveFactory = new HashMap<>();
    ...
    static {
        ...
        moveFactory.put("paralyze", () -> new Debuff("paralyze", ElectricType.getInstance(), StatType.SPEED, 10, 2));
        moveFactory.put("overheat", () -> new Buff("overheat", FireType.getInstance(), StatType.ATTACK, 10, 2));
    }

    public static Move getMoveInstance(String moveName) {
        Supplier<Move> supplier = moveFactory.get(moveName.toLowerCase());
